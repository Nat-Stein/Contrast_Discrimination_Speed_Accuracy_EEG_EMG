...
save(fullfile(figData, 'SSVEPindFreq'),'meanSL_FreqSubj','RTmeanS')
...
for freq = 1:length(take_freqs)
    ...
    csvwrite(fullfile(figData, ['regression_table_singleFreq' num2str(take_freqs(freq)) '.csv']),regression_table_singleFreq)
    % Format:
